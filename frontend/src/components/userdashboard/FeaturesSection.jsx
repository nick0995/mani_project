...
//               </div>
//               <h3>Certificates</h3>
//               <p>Obtain certificates that hold value within the department.</p>
//             </div>
//           </div>
//           <div className="col-md-6 col-lg-3">
//             <div className="feature-card">
...
//               <p>Receive education from skilled professionals with a wealth of practical experience.</p>
//             </div>
//           </div>
//           <div className="col-md-6 col-lg-3">
//             <div className="feature-card">
...
//               <p>Experiential exercises, video tutorials, and learning materials to advance your skills.</p>
//             </div>
//           </div>
//           <div className="col-md-6 col-lg-3">
//             <div className="feature-card">
...
//               </div>
//               <h3>Support for Your Career Goals</h3>
//               <p>Enhanced understanding and abilities for you following course completion.</p>
//             </div>
//           </div>
//         </div>
//       </div>
