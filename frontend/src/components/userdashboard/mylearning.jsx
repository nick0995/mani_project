...
//         </div>
//         <div>
//           <span className="sidebar-logo-text">Officer Dashboard</span>
//           <p className="sidebar-logo-subtext">Punjab Police</p>
//         </div>
//       </motion.div>
//       <button
...
//             <p className="sidebar-profile-academy">rank</p>
//           </div>
//         </div>
//       </motion.div>
//     </div>
...
//         return <OfficerDetails officer={officer} />;  
//       case 'courses':
...
import React, { useState, useEffect } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { User, Bell, Menu, Search, Home, BookOpen, CheckCircle, Clock, Star, Calendar, Trophy, Play, ChevronRight, LogOut } from "lucide-react";
...
const LoadingSpinner = () => (
  <div className="loading-spinner-container">
    ...
    >
      ...
      <motion.h2 className="loading-spinner-title">Officer's Dashboard</motion.h2>
      <motion.p className="loading-spinner-text">loading...</motion.p>
    </motion.div>
  </div>
);
//  Stat Card Component
  ...
  return (
    ...
    >
      <div className="sidebar-header">
        ...
        <button onClick={() => setSidebarOpen(false)} className="sidebar-close-button lg:hidden">✖</button>
      </div>
      ...
      <div className="sidebar-profile-section">
        ...
        >
          ...
          >
            ...
            <div>
              <p className="sidebar-profile-name">{officer?.name || "Officer"}</p>
              <p className="sidebar-profile-academy">{officer?.rank || "Rank"}</p>
            </div>
          </div>
          ...
          {profileMenuOpen && (
            <motion.div
              ...
              className="absolute right-0 mt-2 w-40 bg-white shadow-lg rounded-md overflow-hidden z-20"
            >
              <button
        ...
        <div className="header-right-section">
          ...
          >
            ...
            >
              ...
              <div className="header-profile-text-container md:block">
                <p className="header-profile-name">{officer?.name || "Officer"}</p>
                <p className="header-profile-status">online</p>
              </div>
            </div>
  ...
  >
    ...
    >
      ...
      >
          ...
          <div className="dashboard-deadlines-card-body">
            <div className="dashboard-deadline-item dashboard-deadline-item-red">
              <div className="dashboard-deadline-item-content">
                ...
                <div className="dashboard-deadline-details">
                  <h3 className="dashboard-deadline-title dashboard-deadline-title-red">
                    CCTNS Final Assessment
                  </h3>
                  <p className="dashboard-deadline-date dashboard-deadline-date-red">
                    Due: Feb 15, 2024
                  </p>
                  <div className="dashboard-deadline-footer">
                    <span className="dashboard-deadline-days-left dashboard-deadline-days-left-red">
                      2 days left
                    </span>
                    <button className="dashboard-deadline-button dashboard-deadline-button-red">
                      Start Now
            ...
            <div className="dashboard-deadline-item dashboard-deadline-item-amber">
              <div className="dashboard-deadline-item-content">
                ...
                <div className="dashboard-deadline-details">
                  <h3 className="dashboard-deadline-title dashboard-deadline-title-amber">
                    Khoj App Quiz
                  </h3>
                  <p className="dashboard-deadline-date dashboard-deadline-date-amber">
                    Due: Feb 20, 2024
                  </p>
                  <div className="dashboard-deadline-footer">
                    <span className="dashboard-deadline-days-left dashboard-deadline-days-left-amber">
                      7 days left
                    </span>
                    <button className="dashboard-deadline-button dashboard-deadline-button-amber">
                      Review
        ...
        >
          <h3 className="dashboard-learning-streak-title">Learning Streak</h3>
          <p className="dashboard-learning-streak-text">
...
const OfficerDetails = ({ officer }) => (
  ...
  >
    ...
    <form className="officer-details-form">
      <div className="form-group">
        <label>Name</label>
        <input type="text" value={officer?.name || ""} readOnly />
      </div>

      <div className="form-group">
        <label>Rank</label>
        <input type="text" value={officer?.rank || ""} readOnly />
      </div>

      <div className="form-group">
        <label>Belt No</label>
        <input type="text" value={officer?.belt || ""} readOnly />
      </div>

      <div className="form-group">
        <label>Email</label>
        <input type="text" value={officer?.email || ""} readOnly />
      </div>

      <div className="form-group">
        <label>Mobile</label>
        <input type="text" value={officer?.mobile || ""} readOnly />
      </div>

      <div className="form-group">
        <label>District</label>
        <input type="text" value={officer?.district || ""} readOnly />
      </div>

      <div className="form-group">
        <label>Police Station</label>
        <input type="text" value={officer?.policeStation || ""} readOnly />
      </div>
    </form>
  </motion.div>
);
...
const Achievements = () => (
  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="achievements-container">
    ...
    <p className="achievements-subtitle">Your earned awards will appear here.</p>
  </motion.div>
);
