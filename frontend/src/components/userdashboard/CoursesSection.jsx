...
const CoursesSection = () => {
  ...
  // handle enroll for logged-in user
      ...
      <div className="relative z-10 container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-300">
            Explore top-notch training programs for Punjab Police.
          </p>
        </div>
            ...
            {courses.map((course) => (
              <div key={course.id} className="p-4">
                <div className="bg-white/5 backdrop-blur-md border border-white/20 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300">
                  <div className="course-img">
                    <img
                      src={`http://localhost:5000/public/images/${course.img}`}
                      alt={course.title}
                  ...
                  <div className="p-6">
                    ...
                    <div className="mt-4 flex justify-between items-center">
                      ...
                      <button
                        ...
                        className="bg-gradient-to-r from-red-600 to-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium hover:scale-105 transition-all"
                      >
                        Enroll
                      </button>
                    </div>
